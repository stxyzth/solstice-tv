...
(function () {
    ...
    var LIVE_CHANNELS = [
        { cat: 'News', name: 'NASA TV', url: 'https://ntv1.akamaized.net/hls/live/2014075/NASA-NTV1-HLS/master.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/NASA_logo.svg/200px-NASA_logo.svg.png' },
        { cat: 'News', name: 'Al Jazeera English', url: 'https://live-hls-web-aje.getaj.net/AJE/01.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/en/thumb/f/f2/Aljazeera_eng.svg/200px-Aljazeera_eng.svg.png' },
        { cat: 'News', name: 'DW News', url: 'https://dwamdstream102.akamaized.net/hls/live/2015525/dwstream102/index.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Deutsche_Welle_Logo.svg/200px-Deutsche_Welle_Logo.svg.png' },
        { cat: 'News', name: 'France 24 English', url: 'https://stream.france24.com/live/hls/f24_en.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/en/thumb/2/24/France_24_logo.svg/200px-France_24_logo.svg.png' },
        { cat: 'News', name: 'CGTN', url: 'https://news.cgtn.com/resource/live/english/cgtn-news.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/CGTN.svg/200px-CGTN.svg.png' },
        { cat: 'Entertainment', name: 'Pluto TV Movies', url: 'https://service-stitcher.clusters.pluto.tv/v1/stitch/embed/hls/channel/5f1abd3e4613de000749a3fc/master.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Pluto_TV_2020_logo.svg/200px-Pluto_TV_2020_logo.svg.png' },
        { cat: 'Music', name: 'Lofi Girl Radio', url: 'https://play.streamafrica.net/lofiradio', icon: 'https://yt3.googleusercontent.com/LBME0CsDmCgPuJi2RaTNIIpFBp2EFyDm0XDhk0E1iK2WX9LMdPDfOuZNq6GAlID93BHfiK3cGQ=s176-c-k-c0x00ffffff-no-rj' },
        { cat: 'Science', name: 'NASA ISS Live', url: 'https://ntv2.akamaized.net/hls/live/2014076/NASA-NTV2-HLS/master.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/ISS_emblem.png/200px-ISS_emblem.png' },
        { cat: 'Entertainment', name: 'ABC News Live', url: 'https://content.uplynk.com/channel/3324f2467c414329b3b0cc5cd987b6be.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/ABC_News_2021.svg/200px-ABC_News_2021.svg.png' },
        { cat: 'Sports', name: 'Red Bull TV', url: 'https://rbmn-live.akamaized.net/hls/live/590964/BossLifeLive/master.m3u8', icon: 'https://upload.wikimedia.org/wikipedia/en/thumb/b/b7/Red_Bull_TV_logo.svg/200px-Red_Bull_TV_logo.svg.png' }
    ];

    var LIVE_CATS_LIST = ['News', 'Entertainment', 'Sports', 'Music', 'Science'];

    // Real free VOD — official Blender Foundation artwork
    var REAL_MOVIES = [
        { name: 'Big Buck Bunny', genre: 'Animation', year: '2008', rating: 7.1, url: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8', plot: 'A giant rabbit seeks revenge on three bullying rodents in this open-source animated short that became a standard for video testing worldwide.', poster: 'https://peach.blender.org/wp-content/uploads/poster_bunny_big.jpg', backdrop: 'https://peach.blender.org/wp-content/uploads/bbb-splash.png' },
        { name: 'Sintel', genre: 'Animation', year: '2010', rating: 7.5, url: 'https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8', plot: 'A lone warrior searches for a baby dragon she befriended, braving dangerous lands and discovering the true cost of her quest.', poster: 'https://durian.blender.org/wp-content/uploads/2010/06/sintel_poster.jpg', backdrop: 'https://durian.blender.org/wp-content/uploads/2010/09/sintel_screenshot_temple.jpg' },
        { name: 'Tears of Steel', genre: 'Sci-Fi', year: '2012', rating: 6.4, url: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8', plot: 'In a dystopian future, a group of warriors and scientists must reverse the effects of a devastating robot invasion using untested time-travel technology.', poster: 'https://mango.blender.org/wp-content/uploads/2012/05/01_thom_702.jpg', backdrop: 'https://mango.blender.org/wp-content/uploads/2012/09/screenshot_widescreen.jpg' },
        { name: 'Elephant\'s Dream', genre: 'Animation', year: '2006', rating: 6.0, url: 'https://test-streams.mux.dev/pts_shift/master.m3u8', plot: 'Two characters explore a surreal machine-world, finding that their perceptions of reality differ in fundamental and irreconcilable ways.', poster: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Elephants_Dream_cover.jpg/220px-Elephants_Dream_cover.jpg', backdrop: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Elephants_Dream_s2_proog.jpg/1280px-Elephants_Dream_s2_proog.jpg' },
        { name: 'Caminandes: Llama Drama', genre: 'Comedy', year: '2013', rating: 7.3, url: 'https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_ts/master.m3u8', plot: 'A determined llama tries everything to cross a road blocked by an uncooperative fence in the Patagonian steppe.', poster: 'https://upload.wikimedia.org/wikipedia/en/2/2a/Caminandes_-_Llama_Drama_poster.jpg', backdrop: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Caminandes-_Gran_Dillama_screenshot.png/1280px-Caminandes-_Gran_Dillama_screenshot.png' },
        { name: 'Spring', genre: 'Drama', year: '2019', rating: 7.8, url: 'https://test-streams.mux.dev/test_001/stream.m3u8', plot: 'A shepherd dog and his owner live in a peaceful valley until a playful deer changes their quiet existence forever.', poster: 'https://cloud.blender.org/p/spring/5cad70a562346214e8af97e2/spring-poster.jpg', backdrop: 'https://cloud.blender.org/p/spring/5cac47c162346214e8af8f59/spring-screen-01.jpg' },
        { name: 'Agent 327: Operation Barbershop', genre: 'Action', year: '2017', rating: 7.0, url: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8', plot: 'Dutch secret agent 327 investigates a suspicious barbershop in this fast-paced animated action short.', poster: 'https://upload.wikimedia.org/wikipedia/en/1/1e/Agent_327_-_Operation_Barbershop.png', backdrop: 'https://upload.wikimedia.org/wikipedia/en/1/1e/Agent_327_-_Operation_Barbershop.png' },
        { name: 'Cosmos Laundromat', genre: 'Sci-Fi', year: '2015', rating: 6.8, url: 'https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8', plot: 'A suicidal sheep on an isolated island meets a mysterious being who offers him the chance to live countless alternative lives.', poster: 'https://upload.wikimedia.org/wikipedia/en/1/10/Cosmos_Laundromat_-_First_Cycle.png', backdrop: 'https://upload.wikimedia.org/wikipedia/en/1/10/Cosmos_Laundromat_-_First_Cycle.png' }
    ];

    var REAL_SERIES = [
        { name: 'Blender Open Movies', genre: 'Animation', year: '2006', plot: 'The complete collection of open-source animated films from the Blender Foundation.', seasons: 3, poster: 'https://durian.blender.org/wp-content/uploads/2010/06/sintel_poster.jpg', backdrop: 'https://durian.blender.org/wp-content/uploads/2010/09/sintel_screenshot_temple.jpg' },
        { name: 'NASA Explorers', genre: 'Documentary', year: '2018', plot: 'Scientists and engineers at NASA push the boundaries of space exploration.', seasons: 2, poster: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/NASA_logo.svg/200px-NASA_logo.svg.png', backdrop: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/International_Space_Station_after_undocking_of_STS-132.jpg/1280px-International_Space_Station_after_undocking_of_STS-132.jpg' },
        { name: 'Nature Chronicles', genre: 'Documentary', year: '2020', plot: 'A deep dive into the planet\'s most extraordinary ecosystems and the creatures that call them home.', seasons: 2, poster: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Moraine_Lake_17092005.jpg/220px-Moraine_Lake_17092005.jpg', backdrop: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Moraine_Lake_17092005.jpg/1280px-Moraine_Lake_17092005.jpg' }
    ];
